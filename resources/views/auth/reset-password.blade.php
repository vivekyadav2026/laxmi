        ...
        <div class="relative z-10">
            ...
            <div class="space-y-8 mt-10">
                ...
                <div class="flex items-start">
                    ...
                    <div class="flex flex-col">
                        <span class="font-bold text-white text-base leading-tight mb-0.5">Fast & Secure Launch</span>
                        <span class="text-xs text-gray-400">Onboard your startup in simple steps</span>
                    </div>
                </div>
            </div>
        </div>
