...
@section('content')
    <div class="mb-8 relative z-10">
        ...
        <h1 class="text-3xl font-extrabold text-white font-serif drop-shadow-md">Create New Post</h1>
        <p class="text-sm text-gray-400">Publish a new English & Hindi article to the blog.</p>
    </div>
    ...
    <form action="{{ route('admin.blogs.store') }}" method="POST" class="relative z-10" x-data="{ 
        tab: 'basic',
            ...
            <div class="bg-white/5 border border-white/10 rounded-3xl p-6 md:p-8 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="flex flex-col">
                        ...
                        <input type="text" name="title_en" id="title_en" x-model="titleEn" @input="updateSlug" required
                    ...
                    <div class="flex flex-col">
                        ...
                        <input type="text" name="title_hi" id="title_hi" value="{{ old('title_hi') }}" required
                            class="bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold text-sm"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <!-- Slug -->
                    <div class="flex flex-col">
                        <label for="slug" class="text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Slug (URL Identifier)</label>
                        <input type="text" name="slug" id="slug" x-model="slug" @input="slugManuallyEdited = true"
                            ...
                            placeholder="e.g. trademark-registration-india">
                        <span class="text-[10px] text-gray-500 mt-1.5">If left empty, a unique slug will be auto-generated.</span>
                    </div>
                    ...
                    <div class="flex flex-col">
                        ...
                        <select name="category" id="category" required
                            ...
                            <option value="gst" {{ old('category') === 'gst' ? 'selected' : '' }}>GST / TAX</option>
                            <option value="trademark" {{ old('category') === 'trademark' ? 'selected' : '' }}>TRADEMARK</option>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="flex flex-col">
                        ...
                        <input type="text" name="date" id="date" value="{{ old('date', date('F d, Y')) }}" required
                            class="bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold text-sm"
                    ...
                    <div class="flex flex-col">
                        ...
                        <input type="text" name="read_time" id="read_time" value="{{ old('read_time', '6 min read') }}" required
                            class="bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold text-sm"
                ...
                <div class="flex flex-col">
                    ...
                    <textarea name="excerpt" id="excerpt" rows="3" required
                        ...
                        placeholder="A short summary shown on the blog index cards...">{{ old('excerpt') }}</textarea>
                </div>
            </div>
            ...
            <div class="bg-white/5 border border-white/10 rounded-3xl p-6 md:p-8 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="flex flex-col">
                        ...
                        <input type="text" name="author" id="author" value="{{ old('author', 'CA Amit Kumar') }}" required
                            class="bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold text-sm"
                            placeholder="e.g. CA Amit Kumar">
                    </div>
                    ...
                    <div class="flex flex-col">
                        ...
                        <input type="text" name="author_role" id="author_role" value="{{ old('author_role', 'Tax & Startup Advisor') }}" required
                            class="bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold text-sm"
                            placeholder="e.g. Tax & Startup Advisor">
                    </div>
                </div>
                ...
                <div class="flex flex-col">
                    ...
                    <textarea name="author_bio" id="author_bio" rows="3" required
                        class="bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold text-sm resize-none"
                        placeholder="A short professional profile about the author...">{{ old('author_bio') }}</textarea>
                </div>
            </div>
        ...
        <div x-show="tab === 'content'" class="space-y-6" style="display: none;">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="flex flex-col">
                        ...
                        <textarea name="takeaways" id="takeaways" rows="4" required
                            class="bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold text-sm"
                            placeholder="Enter each point on a new line...">{{ old('takeaways') }}</textarea>
                    ...
                    <div class="flex flex-col">
                        ...
                        <textarea name="tags" id="tags" rows="4" required
                            class="bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold text-sm"
                            placeholder="e.g. Company Registration, Pvt Ltd, LLP, Startup">{{ old('tags') }}</textarea>
            ...
            <!-- Content Sections -->
            @for ($i = 1; $i <= 3; $i++)
                <div class="bg-white/5 border border-white/10 rounded-3xl p-6 md:p-8 space-y-6" x-data="{ hasTable: false }">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="flex flex-col">
                            ...
                            <input type="text" name="section_{{ $i }}_heading_hi" id="section_{{ $i }}_heading_hi" value="{{ old('section_' . $i . '_heading_hi') }}" {{ $i === 1 ? 'required' : '' }}
                                class="bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold text-sm"
                        ...
                        <div class="flex flex-col">
                            ...
                            <input type="text" name="section_{{ $i }}_heading_en" id="section_{{ $i }}_heading_en" value="{{ old('section_' . $i . '_heading_en') }}" {{ $i === 1 ? 'required' : '' }}
                                class="bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold text-sm"
                    ...
                    <div class="flex flex-col">
                        ...
                        <textarea name="section_{{ $i }}_paragraphs" id="section_{{ $i }}_paragraphs" rows="5" {{ $i === 1 ? 'required' : '' }}
                            class="bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold text-sm"
                            placeholder="Enter paragraph text. Press Enter for new paragraphs..."></textarea>
                    ...
                    <div x-show="hasTable" class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-white/5" style="display: none;">
                        <div class="flex flex-col">
                            ...
                            <input type="text" name="section_{{ $i }}_table_headers" id="section_{{ $i }}_table_headers" value="{{ old('section_' . $i . '_table_headers') }}"
                                class="bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold text-sm"
                        ...
                        <div class="flex flex-col">
                            ...
                            <textarea name="section_{{ $i }}_table_rows" id="section_{{ $i }}_table_rows" rows="3"
                                class="bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold text-sm"
                                placeholder="e.g. Min Members, 2, 2, 1&#10;Liability, Limited, Limited, Limited"></textarea>
            ...
            <div class="bg-white/5 border border-white/10 rounded-3xl p-6 md:p-8 space-y-6">
                ...
                <div class="flex flex-col">
                    ...
                    <textarea name="conclusion" id="conclusion" rows="4" required
                        class="bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold text-sm"
                        placeholder="A closing summary or call to action for this article...">{{ old('conclusion') }}</textarea>
                </div>
            </div>
