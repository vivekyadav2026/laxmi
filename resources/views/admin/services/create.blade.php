...
@section('content')
    <div class="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4 relative z-10">
        <div>
            <h1 class="text-3xl font-extrabold text-white font-serif mb-1 drop-shadow-md">Add New Service</h1>
            <p class="text-sm text-gray-400">Create a new service offering for your customers.</p>
        </div>
        ...
        <form action="{{ route('admin.services.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="name_en" id="name_en" value="{{ old('name_en') }}" class="w-full bg-navy/40 border border-white/10 rounded-xl py-3 px-4 text-white placeholder-gray-600 focus:outline-none focus:border-gold/50 focus:ring-1 focus:ring-gold/50 transition-all text-sm shadow-inner" placeholder="e.g. Private Limited Company" required>
                ...
                <div>
                    ...
                    <input type="text" name="name_hi" id="name_hi" value="{{ old('name_hi') }}" class="w-full bg-navy/40 border border-white/10 rounded-xl py-3 px-4 text-white placeholder-gray-600 focus:outline-none focus:border-gold/50 focus:ring-1 focus:ring-gold/50 transition-all text-sm shadow-inner" placeholder="e.g. Private Limited">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="badge_hi" id="badge_hi" value="{{ old('badge_hi') }}" class="w-full bg-navy/40 border border-white/10 rounded-xl py-3 px-4 text-white placeholder-gray-600 focus:outline-none focus:border-gold/50 focus:ring-1 focus:ring-gold/50 transition-all text-sm shadow-inner" placeholder="e.g. 50% OFF">
