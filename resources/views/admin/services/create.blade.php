        ...
        <form action="{{ route('admin.services.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="name_hi" id="name_hi" value="{{ old('name_hi') }}" class="w-full bg-navy/40 border border-white/10 rounded-xl py-3 px-4 text-white placeholder-gray-600 focus:outline-none focus:border-gold/50 focus:ring-1 focus:ring-gold/50 transition-all text-sm shadow-inner" placeholder="e.g. प्राइवेट लिमिटेड">
