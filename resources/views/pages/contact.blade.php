            ...
            <div class="w-full lg:w-2/5 space-y-6">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 hover:-translate-y-1 transition-transform duration-300">
                    <div class="flex items-start">
                        ...
                        <div class="flex flex-col">
                            <span class="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">हेल्पलाइन नंबर / Helpline Number</span>
                            <a href="tel:+918069029400" class="text-2xl font-extrabold text-navy hover:text-gold transition-colors">080-6902-9400</a>
                        </div>
                    </div>
                </div>
