...
<div class="bg-offwhite py-8 min-h-screen">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-sm text-gray-500 mb-6 font-medium flex items-center gap-2">
            ...
            <span>/</span>
            <a href="/vakeel-search" class="hover:text-gold transition font-bold text-navy">Find Lawyer</a>
            <span>/</span>
            <span class="text-gray-700 font-bold">{{ $lawyer->name }}</span>
        </div>
                ...
                <div class="pt-20 md:pt-24 flex flex-col lg:flex-row justify-between lg:items-end gap-6">
                    <div class="flex-1">
                        <div class="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 mb-2">
                            ...
                            @if($lawyer->verified)
                                <div class="bg-green-50 text-green-700 px-3 py-1.5 rounded-md flex items-center border border-green-200 shadow-sm text-xs font-bold w-max">
                        ...
                        <div class="flex flex-wrap items-center gap-3 mb-6">
                            <!-- City -->
                            <span class="inline-flex items-center px-3 py-1.5 rounded bg-navy text-white shadow-sm font-bold text-xs">
                            ...
                            <!-- Experience -->
                            <span class="inline-flex items-center px-3 py-1.5 rounded bg-gray-50 border border-gray-100 text-navy shadow-sm font-bold text-xs">
                    ...
                    <div class="flex flex-col lg:items-end w-full lg:w-auto">
                        <div class="flex flex-wrap lg:justify-end gap-4 border-t lg:border-t-0 border-gray-100 pt-4 lg:pt-0">
                            <div class="flex flex-col bg-gray-50 px-4 py-2 rounded-lg border border-gray-100 items-center min-w-[80px]">
                                ...
                                <span class="text-[10px] uppercase font-bold text-gray-500">{{ $lawyer->reviews }} Reviews</span>
                            </div>
                            
                            <div class="flex flex-col bg-gray-50 px-4 py-2 rounded-lg border border-gray-100 items-center min-w-[80px]">
                                <span class="font-bold text-navy text-lg mb-0.5">{{ $lawyer->cases }}+</span>
                                <span class="text-[10px] uppercase font-bold text-gray-500">Cases</span>
                            </div>

                            <div class="flex flex-col bg-gray-50 px-4 py-2 rounded-lg border border-gray-100 items-center min-w-[80px]">
                                <span class="font-bold text-navy text-lg mb-0.5">{{ $lawyer->response_rate }}%</span>
                                <span class="text-[10px] uppercase font-bold text-gray-500">Response</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex-1 w-full lg:w-[65%]" x-data="{ tab: 'about' }">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 mb-6 p-2 overflow-x-auto">
                    <nav class="flex min-w-max space-x-2" aria-label="Tabs">
                        <button @click="tab = 'about'" :class="tab === 'about' ? 'bg-navy text-white shadow-md' : 'text-gray-600 hover:bg-gray-50'" class="flex items-center justify-center px-6 min-h-[44px] font-bold text-sm rounded-lg transition-all flex-1 min-w-[120px]">
                            About
                        </button>
                        <button @click="tab = 'expertise'" :class="tab === 'expertise' ? 'bg-navy text-white shadow-md' : 'text-gray-600 hover:bg-gray-50'" class="flex items-center justify-center px-6 min-h-[44px] font-bold text-sm rounded-lg transition-all flex-1 min-w-[120px]">
                            Expertise
                        </button>
                        <button @click="tab = 'reviews'" :class="tab === 'reviews' ? 'bg-navy text-white shadow-md' : 'text-gray-600 hover:bg-gray-50'" class="flex items-center justify-center px-6 min-h-[44px] font-bold text-sm rounded-lg transition-all flex-1 min-w-[120px]">
                            Reviews
                        </button>
                        <button @click="tab = 'cases'" :class="tab === 'cases' ? 'bg-navy text-white shadow-md' : 'text-gray-600 hover:bg-gray-50'" class="flex items-center justify-center px-6 min-h-[44px] font-bold text-sm rounded-lg transition-all flex-1 min-w-[120px]">
                            Cases Won
                        </button>
                    </nav>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sm:p-8 hover:-translate-y-1 transition-transform duration-300">
                    ...
                    <div x-show="tab === 'about'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform scale-95" x-transition:enter-end="opacity-100 transform scale-100">
                        <div class="mb-8">
                            <h2 class="text-2xl font-bold text-navy leading-tight mb-4">Biography</h2>
                            <p class="text-gray-600 text-sm leading-relaxed">{{ $lawyer->about_en ?: $lawyer->about_hi }}</p>
                        </div>

                        <div class="border-t border-gray-100 pt-8 mb-8">
                            <h2 class="text-xl font-bold text-navy leading-tight mb-6">Education</h2>
                    ...
                    <div x-show="tab === 'expertise'" style="display: none;" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform scale-95" x-transition:enter-end="opacity-100 transform scale-100">
                        <h2 class="text-2xl font-bold text-navy leading-tight mb-6">Practice Areas & Expertise</h2>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            @foreach($lawyer->expertise as $exp)
                                <div class="bg-gray-50 p-5 rounded-xl border border-gray-200 hover:border-gold transition-colors flex items-center justify-between">
                                    <h3 class="font-bold text-navy text-base">{{ $exp['name_en'] ?: $exp['name_hi'] }}</h3>
                    ...
                    <div x-show="tab === 'reviews'" style="display: none;" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform scale-95" x-transition:enter-end="opacity-100 transform scale-100">
                        <h2 class="text-2xl font-bold text-navy leading-tight mb-8">Client Reviews</h2>
                        ...
                        <div class="flex flex-col sm:flex-row items-center gap-8 bg-gray-50 p-6 rounded-xl border border-gray-100 mb-8">
                            <div class="flex flex-col items-center">
                                ...
                                <span class="font-bold text-gray-600 text-sm">{{ $lawyer->reviews }} Total Reviews</span>
                            </div>
                        ...
                        <div class="space-y-4">
                            @foreach($lawyer->recent_reviews as $review)
                                <div class="border-b border-gray-100 pb-6 last:border-0 last:pb-0">
                                    ...
                                    <div class="text-gold text-sm mb-2">
                                        {{ str_repeat('★', $review['stars']) }}{{ str_repeat('☆', 5 - $review['stars']) }}
                                    </div>
                                    <p class="text-gray-600 text-sm leading-relaxed">{{ $review['text_en'] ?: $review['text_hi'] }}</p>
                                </div>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div x-show="tab === 'cases'" style="display: none;" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform scale-95" x-transition:enter-end="opacity-100 transform scale-100">
                        <h2 class="text-2xl font-bold text-navy leading-tight mb-6">Recent Cases Won</h2>
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            @foreach($lawyer->cases_won as $case)
                                <div class="bg-white border border-gray-200 p-4 rounded-xl shadow-sm flex items-center gap-4">
                                    ...
                                    <h3 class="font-bold text-navy text-base leading-tight">{{ $case['title_en'] ?: $case['title_hi'] }}</h3>
                                </div>
                            @endforeach
                        </div>
                    </div>
            ...
            <aside class="w-full lg:w-[35%] flex-shrink-0">
                <div class="bg-white rounded-2xl shadow-xl border border-gray-200 p-6 sticky top-28 hover:-translate-y-1 transition-transform duration-300">
                    ...
                    <div class="flex flex-col mb-6 pb-4 border-b border-gray-100">
                        <h2 class="text-2xl font-bold text-navy leading-tight">Book Consultation</h2>
                    </div>
                    ...
                    <form action="#">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-3 gap-2">
                                <label class="cursor-pointer">
                                    ...
                                    <div class="flex flex-col items-center justify-center p-2 rounded-lg border-2 border-gray-200 bg-white peer-checked:border-gold peer-checked:bg-gold/5 transition min-h-[56px]">
                                        <span class="text-base mb-0.5">📹</span>
                                        <span class="text-xs font-bold text-navy">Video</span>
                                    </div>
                                </label>
                                <label class="cursor-pointer">
                                    ...
                                    <div class="flex flex-col items-center justify-center p-2 rounded-lg border-2 border-gray-200 bg-white peer-checked:border-gold peer-checked:bg-gold/5 transition min-h-[56px]">
                                        <span class="text-base mb-0.5">📞</span>
                                        <span class="text-xs font-bold text-navy">Phone</span>
                                    </div>
                                </label>
                                <label class="cursor-pointer">
                                    <input type="radio" name="cons_type" class="peer sr-only">
                                    <div class="flex flex-col items-center justify-center p-2 rounded-lg border-2 border-gray-200 bg-white peer-checked:border-gold peer-checked:bg-gold/5 transition min-h-[56px]">
                                        <span class="text-base mb-0.5">🏢</span>
                                        <span class="text-xs font-bold text-navy">In-Person</span>
                                    </div>
                                </label>
                            </div>
                        </div>
                        ...
                        <!-- Date Picker Pills -->
                        <div class="mb-6">
                            <label class="block text-sm font-bold text-navy leading-tight mb-3">Select Date</label>
                            <div class="flex gap-2 overflow-x-auto pb-2 custom-scrollbar">
                                ...
                                <label class="cursor-pointer flex-shrink-0">
                                    ...
                                    <div class="flex flex-col items-center justify-center w-14 py-2 rounded-lg border-2 border-gray-200 bg-white peer-checked:border-navy peer-checked:bg-navy peer-checked:text-white transition">
                                        <span class="text-xs font-bold mb-0.5 peer-checked:text-white text-navy">{{ $d['en'] }}</span>
                                        <span class="text-lg font-bold leading-none">{{ $d['date'] }}</span>
                                    </div>
                                </label>
                                @endforeach
                            </div>
                        ...
                        <!-- Time Slots Grid -->
                        <div class="mb-8">
                            <label class="block text-sm font-bold text-navy leading-tight mb-3">Select Time</label>
                            <div class="grid grid-cols-3 gap-2">
                                ...
                                <label class="cursor-pointer">
                                    ...
                                    <div class="flex items-center justify-center py-2 px-1 rounded-md border border-gray-200 bg-gray-50 peer-checked:border-gold peer-checked:bg-gold peer-checked:text-navy text-gray-600 font-semibold text-xs min-h-[44px] transition">
                                        {{ $time }}
                                    </div>
                                </label>
                                @endforeach
                        ...
                        <div class="bg-offwhite rounded-xl p-4 border border-gray-200 mb-6">
                            <div class="flex justify-between items-center mb-2 text-sm">
                                <span class="font-bold text-navy">Consultation Fee</span>
                            ...
                            <div class="flex justify-between items-center mb-3 text-sm pb-3 border-b border-gray-200">
                                <span class="font-bold text-navy">GST (18%)</span>
                                <span class="font-bold text-navy">₹{{ round($lawyer->fee * 0.18) }}</span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-base font-bold text-navy">Total Payable</span>
                        ...
                        <div class="flex flex-col gap-3">
                            <button type="button" class="w-full bg-gold text-navy hover:bg-gold-light min-h-[52px] rounded-xl font-bold text-base transition-all duration-300 shadow-md hover:shadow-lg flex items-center justify-center hover:-translate-y-0.5">
                                Book Now
                            </button>
                            
                            <a href="https://wa.me/{{ $whatsappPhone }}" target="_blank" class="w-full bg-[#25D366] text-white hover:bg-[#20b858] min-h-[52px] rounded-xl font-bold text-sm transition-all duration-300 shadow-md hover:shadow-lg flex items-center justify-center hover:-translate-y-0.5">
