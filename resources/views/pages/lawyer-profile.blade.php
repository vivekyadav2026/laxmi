                ...
                <div class="bg-white rounded-2xl shadow-xl border border-gray-200 p-6 sticky top-28 hover:-translate-y-1 transition-transform duration-300">
                    ...
                    <form action="#">
                        ...
                        <div class="flex flex-col gap-3">
                            ...
                            <a href="https://wa.me/{{ $whatsappPhone }}" target="_blank" class="w-full bg-[#25D366] text-white hover:bg-[#20b858] min-h-[56px] rounded-xl font-bold transition-all duration-300 shadow-md hover:shadow-lg flex flex-col items-center justify-center hover:-translate-y-0.5">
